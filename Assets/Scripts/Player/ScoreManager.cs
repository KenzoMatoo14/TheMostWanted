...
public class ScoreManager : MonoBehaviour
{
    ...
    /// <summary>
    /// Se llama cuando cambia el total de monedas (recolección o gasto)
    /// </summary>
    private void OnCoinsCollected(int totalCoins)
    {
        ...
        // Si el total bajó (se gastaron monedas, ej. tienda), no sumamos puntaje
    ...
    public void AddScore(int points)
    {
        ...
        currentScore += points;
        Debug.Log($"Puntos a�adidos: +{points}. Total: {currentScore}");
    ...
    /// <summary>
    /// Establece un puntaje espec�fico
    /// </summary>
