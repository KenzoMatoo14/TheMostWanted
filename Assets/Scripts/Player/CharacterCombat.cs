...
public class CharacterCombat : MonoBehaviour
{
    ...
    void MeleeAttack()
    {
        ...
        foreach (RaycastHit2D hit in hitEnemies)
        {
            ...
            if (damageable != null)
            {
                ...
                {
                    // Es un objeto dañable pero no enemigo (como ThrowableBox)
    ...
    private void OnDrawGizmosSelected()
    {
        ...
        // Punto azul para la punta del látigo
        Gizmos.color = Color.blue;
        Gizmos.DrawWireSphere(whipTip.position, 0.1f);

        // Círculo purpura para el rango de captura
        Gizmos.color = Color.purple;
        Gizmos.DrawWireSphere(transform.position, stats.CaptureRange);

        // Visualizar el área de detección del mouse
        ...
        // Mostrar último enemigo hovereado (MAGENTA)
