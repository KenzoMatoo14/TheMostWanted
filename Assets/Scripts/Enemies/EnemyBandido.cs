...
public class EnemyBandido : EnemyBase
{
    ...
    [SerializeField] private LayerMask obstacleLayer; // Capa de paredes/obst�culos
    [SerializeField] private bool requireLineOfSight = true; // Activar/desactivar LOS
    [SerializeField] private float visionCheckInterval = 0.2f; // Frecuencia de chequeo (optimizaci�n)
    [SerializeField] private Transform visionOrigin; // Punto desde donde mira (ojos del enemigo)
    [SerializeField] private bool debugLineOfSight = true; // Mostrar rayos de visi�n
    [SerializeField] private float loseLineOfSightDelay = 0.5f; // Tiempo antes de perder al jugador sin visi�n

    [Header("Attack Settings")]
    [SerializeField] private float attackRange = 1.5f;
    [SerializeField] private float attackCooldown = 1.5f;
    [SerializeField] private int attackDamage = 10;
    [SerializeField] private float attackWindupTime = 0.3f; // Tiempo antes de hacer da�o
    [SerializeField] private Transform attackPoint; // Punto desde donde se verifica el ataque
    [SerializeField] private float attackRadius = 1f; // Radio del �rea de ataque
    ...
    protected override void Start()
    {
        ...
        // Si no se asigna un punto de visi�n, usar la posici�n del enemigo
    ...
    {
        // No hacer nada si est� muerto, capturado o siendo capturado
        ...
        // No moverse si est� completamente aturdido
        if (IsFullyStunned())
        {
            if (rb != null)
            {
    ...
    /// <summary>
    /// Verifica si el enemigo tiene l�nea de visi�n directa al jugador
    /// </summary>
    private bool CheckLineOfSight()
    {
        ...
        {
            // Verificar si lo que golpe� es el jugador
            if (hit.collider.CompareTag("Player"))
            {
                return true; // Visi�n clara al jugador
            }
            else
            {
                // Golpe� un obst�culo antes de llegar al jugador
                return false;
            }
        }

        // No golpe� nada (no deber�a pasar si el jugador tiene collider)
        return false;
    }

    /// <summary>
    /// Actualiza el estado de l�nea de visi�n con intervalo de tiempo (optimizaci�n)
    /// </summary>
    private void UpdateLineOfSight()
    {
        ...
        if (visionCheckTimer <= 0f)
        {
            ...
            // Si perdi� l�nea de visi�n, empezar a contar
            ...
            // Si recuper� l�nea de visi�n, resetear contador
        ...
        // Si no tiene l�nea de visi�n, incrementar el contador
    ...
    private void StartAttack()
    {
        ...
        // Aqu� puedes activar animaci�n de ataque
    ...
    {
        // Verificar si hay un obst�culo delante usando OverlapCircle (igual que groundCheck)
        bool hasObstacle = CheckObstacleAhead();

        // Verificar si el jugador est� encima
        ...
        if (hasObstacle || playerAbove)
        {
            if (debugJump)
            {
                string reason = hasObstacle ? "obst�culo detectado" : "jugador encima";
    ...
    private void PerformJump()
    {
        ...
        if (debugJump)
        {
            Debug.Log($"{gameObject.name} realiz� un salto con fuerza {jumpForce}");
        }
    ...
    protected override void OnDamageTakenCustom(int damageAmount)
    {
        ...
        // Entrar en modo persecuci�n si est� patrullando
    ...
    protected override void OnDeathCustom()
    {
        ...
        if (rb != null)
        {
            ...
            // Activar gravedad alta para ca�da r�pida
            ...
            // Asegurarse de que el Rigidbody est� activo
            rb.simulated = true;
        ...
        // Destruir despu�s de que caiga (puedes ajustar el tiempo)
    ...
    private void OnDrawGizmosSelected()
    {
        ...
        // Detecci�n de obst�culos para salto
        if (canJump)
        {
